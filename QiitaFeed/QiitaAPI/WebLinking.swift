...
/// https://github.com/kylef-archive/WebLinking.swift/blob/master/Sources/WebLinking.swift
...
struct Link: Equatable, Hashable {
    ...
    init(uri: String, parameters: [String: String]? = nil) {
        self.uri = uri
    ...
    var reverseRelationType: String? {
...
func takeFirst(_ input: [String]) -> (String, ArraySlice<String>) {
    if let first = input.first, !first.isEmpty {
